...
public class NotificationUtils {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "com.example.myapplication.app";
    private static final String NOTIFICATION_CHANNEL_NAME = "com.example.myapplication.app";
